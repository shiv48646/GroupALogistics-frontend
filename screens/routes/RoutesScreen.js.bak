...
const RoutesScreen = ({ navigation }) => {
  ...
  const routes = useSelector(typeof selectFilteredRoutes !== 'undefined' ? selectFilteredRoutes : (s) => s);
  const statistics = useSelector(typeof selectRouteStatistics !== 'undefined' ? selectRouteStatistics : (s) => s) || {
  totalRoutes: 0,
  activeRoutes: 0,
  inTransitRoutes: 0,
  completedRoutes: 0,
